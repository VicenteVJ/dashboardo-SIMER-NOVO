...
function ParetoSection({ tickets, onFilter }) {
  ...
  const cards = Object.entries(PARETO_VIEW_DIMENSIONS).map(([key, config]) => ({ key, label: config.label, value: analyses[key].paretoGroups.length }))
